// El despachador del lote.
//
// Fuera de app/ por lo mismo que los proveedores: Next valida route.js y `route()` no es
// un export valido alli. Y tiene que ser exportable porque scripts/batch.test.mjs lo prueba
// aparte — es la funcion que convierte texto que manda el cliente en llamadas del servidor,
// o sea el sitio exacto donde un parseo flojo se vuelve una peticion a un tercero firmada
// con nuestras claves.
...
import { serve as fmpServe } from './fmp.js';
import { serve as finnhubServe } from './finnhub.js';
import { serve as shortIntServe } from './short-interest.js';
import { serve as finvizServe } from './finviz.js';
import { serve as congressServe } from './congress.js';
import { serve as edgarServe } from './edgar.js';
import { serve as simfinServe } from './simfin.js';
